...
def gerar_lista_datetime(medico: 'Medico', data_inicio: date, data_fim: date, intervalo_minutos: int) -> list[datetime]:

    dias = []
    
    dias_trabalho_ints = [MAPA_DIAS_SEMANA[dia_enum] for dia_enum in medico.dias_atendimento]
